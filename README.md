...
> - Использует локальные LLM-модели через LLM Studio. В числе доступных моделей — GigaChat (Сбербанк), обеспечивающий дружелюбные и информативные ответы на русском языке с глубоким пониманием культуры и истории России.

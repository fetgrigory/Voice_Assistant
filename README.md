...
- [Сравнение голосового ассистента Астра с Алисой и Siri](#Сравнение-голосового-ассистента-Астра-с-Алисой-и-Siri)   
...
| **Мультимедиа (музыка/фильмы)** | ✅ Hitmotop / Kinopoisk | ✅ Яндекс.Музыка / Кинопоиск | ✅ Apple Music / Видео |
| **Интернет-поиск**             | ✅ через Яндекс, по запросу | ✅ Яндекс | ✅ Safari, веб-поиск |
| **Интеграция с локальными LLM** | ✅ дружелюбные ответы без облака | ❌ только облачные ответы | ❌ только облачные ответы |
| **Расширяемость / модульность** | ✅ легко добавлять команды и сервисы | ❌ ограничено | ❌ ограничено |
...
| **Дружественный UX**           | ✅ дружелюбные и структурированные ответы | ✅ стандартный | ✅ стандартный |

...
| **Мультимедиа (музыка/фильмы)** |✅ Hitmotop / zona.im | ⚠️ Яндекс.Музыка (только по подписке, с авторизацией), кино не воспроизводит | ✅ Apple Music / Видео |
...
- **Системные команды**:  
  ...
  - 📋 Ввод текста голосом 
- **Мультимедиа**:  
  - 🎵 Музыка и фильмы (Hitmotop и zona.im, воспроизведение реализовано через Selenium)
- **Интернет**:  

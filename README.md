...
> - Использует локальную LLM-модель GigaChat (Сбер) через LLM Studio, обеспечивающую не только полную конфиденциальность (данные не уходят в облако), но и дружелюбные и информативные ответы на русском языке с глубоким пониманием культуры и истории России  

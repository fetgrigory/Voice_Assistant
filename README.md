...
| **Мультимедиа (музыка/фильмы)** |✅ Hitmotop / Кинопоиск | ✅ Яндекс.Музыка / Кинопоиск | ✅ Apple Music / Видео |
| **Интернет-поиск**             |✅ через DuckDuckGo, по запросу | ✅ Яндекс | ✅ Safari, веб-поиск |

...
> - Использует GigaChat обработка запросов локальная, модель предоставляет дружелюбные и информативные ответы на русском языке с глубоким пониманием культуры и истории России.

...
**Астра** — это голосовой ассистент с локальным распознаванием речи (Vosk) и синтезом (pyttsx3). Он умеет управлять системой, искать информацию в интернете, играть музыку/фильмы и даже общаться через GigaChat!
...
> - Использует LLM Studio и локальные модели (включая нейросеть от Сбербанка) для дружелюбных и информативных ответов на русском языке, с глубоким пониманием культуры и истории.

...
> - Использует локальную LLM-модель GigaChat (Сбер) через LLM Studio, обеспечивающую дружелюбные и информативные ответы на русском языке с глубоким пониманием культуры и истории России
